...
* Docker
    ...
    docker run -it -v /monero/chain:/root/.bitmonero -v /monero/wallet:/wallet -p 18180:18180 monero

    # or in background
    docker run -it -d -v /monero/chain:/root/.bitmonero -v /monero/wallet:/wallet -p 18180:18180 monero
    ```
